...
//button numbers: front - 1 (PF5), side - 2 (PF4), top - 3 (PF6)

dataexchange_t data; //sensors & buttons data structure
params_t calib_params; //magnetometer calibration parameters
params_t EEMEM eeparams;//calibration in eeprom
